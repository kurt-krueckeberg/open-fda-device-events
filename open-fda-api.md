...
To enable flexible searches of public FDA data about drugs, devices and foods, the **FDA** created [openFDA](https://open.fda.gov/apis), which is a public RESTful API which uses the open source search platform [Elasticsearch](https://www.elastic.co/enterprise-search). 
