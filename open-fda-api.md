...
To enable flexible searches of public FDA data about drugs, devices, and foods, the **FDA** created athe public [openFDA](https://open.fda.gov/apis) API, which uses the open source search platform [Elasticsearch](https://www.elastic.co/enterprise-search). 
