...
:::{important}
You can interactively get `count` results of one of several `device` event fields at [Device adverse event reports over time](https://open.fda.gov/apis/device/event/explore-the-api-with-an-interactive-chart/)
:::
