...
The [openFDA](https://open.fda.gov/apis) [RESTful API](https://aws.amazon.com/what-is/restful-api/) supports detailed queries of public FDA information about drugs, devices and foods by supporting the [Elasticsearch](https://www.elastic.co/enterprise-search).
